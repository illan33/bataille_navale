...
def erreurs_coord(case_bats):
    ...
    print (" ")
    case_bats = input("Coordonnées, Sous la forme: x (lettre), y(nombre) Ex: a3 : ")
    return case_bats
...
def chx_bateaux_bot(eq):
    ...
    while h != 0 :
        ...
        if cases[eq,xia,yia] == "Rien" :
            ...
            h -=1
    print("Placement des bateaux de l'",eq,"réussie\n")
    return cases
...
def bataille(eq):
    ...
    for equipe in eq :
        if equipe == "équipe 1" or equipe == "équipe 2":
            print("C'est à l'",equipe,"de répondre")
            if input ("Voulez vous générer vos tirs aléatoirements ? (OUI(O) ou NON(N): ") == "O" :
    ...
    while tour == 0 and bateq1 < bat and bateq2 < bat :
        ...
        if tirs(eq[1],tipes[0]) == 1:
            ...
            tour = 1
        print("Nombre de bateaux restants de l'",eq[1],":",bat-bateq2)
        ...
        while tour == 1 and bateq1 < bat and bateq2 < bat :
            ...
            if tirs(eq[0],tipes[1]) == 1 :
                ...
                tour = 0
        print("Nombre de bateaux restants de l'",eq[0],":",bat-bateq1)
...
while jeu == 0 :
    ...
    for g in equipes:
        if g == "équipe 1" or g == "équipe 2":
            print("Tour de l'",g)
            if input("Voulez vous générer vos bateaux aléatoirement ? (OUI(O) ou NON(N): ") == "O" :
